 ...
 *
 * NTT over Z_Q[X]/(X^256+1), Q = 8380417, primitive 512th root of unity = 1753.
 * Zetas are powers of the root of unity in Montgomery domain (multiplied by 2^32 mod Q)
 * and in bit-reversed order.
 */
#include <stdint.h>
#include "params.h"
#include "ntt.h"
...
/*
 * Table of zetas (powers of root of unity in Montgomery domain, bit-reversed).
 * zetas[i] = root^{brv(i)} * 2^32 (mod Q) where root = 1753 and Q = 8380417.
 *
 * Taken verbatim from pq-crystals/dilithium ref/ntt.c (public domain / CC0).
 */
